...
# Lets grab all the recreation areas for a specific organization, in
# this case the Bureau of Land Management, or BLM, which has an ORG ID
# of 126
  def rec_areas_blm
    self.class.get("/api/v1/organizations/126/recareas", @options)
  end
